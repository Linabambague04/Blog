...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?php echo e(url('/')); ?>">Mi Blog</a>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item me-3">
                        <a href="<?php echo e(route('posts.generarPDF')); ?>" 
                    ...
                    <li class="nav-item d-flex align-items-center me-3">
                        ...
                        <?php if(Auth::user()->avatar && file_exists(public_path('storage/' . Auth::user()->avatar))): ?>
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="text-white text-decoration-none fw-semibold">
                    ...
                    <li class="nav-item dropdown me-3">
                        ...
                        <a class="nav-link position-relative text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <?php if(!empty($navbarNotifCount) && $navbarNotifCount > 0): ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="min-width: 350px;">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $navbarNotifications ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    
                                    
                                    <a class="dropdown-item d-flex align-items-start py-2 <?php if(!$n->read_at): ?> fw-bold <?php endif; ?>" href="<?php echo e($n->data['url'] ?? '#'); ?>">
                                        
                                        
                                        <div class="flex-shrink-0 me-3 mt-1">
                                            <i class="<?php echo e($n->data['icon'] ?? 'bi bi-info-circle-fill text-primary'); ?>"></i>
                                        </div>
                                        
                                        
                                        <div class="flex-grow-1">
                                            <p class="mb-0 small"><?php echo e($n->title); ?></p>
                            ...
                            <li>
                                <a href="<?php echo e(route('notifications.index')); ?>" class="dropdown-item text-center text-primary small py-2">
...
<footer class="footer-custom">
    <p>&copy; <?php echo e(date('Y')); ?> Mi Blog. Todos los derechos reservados.</p>
</footer>
