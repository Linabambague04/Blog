...
<div class="bg-white">
    ...
    <section class="hero-section text-white text-center">
        <div class="container position-relative z-1">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-warning btn-lg fw-bold">Crear nueva publicación</a>
            <?php endif; ?>
        </div>
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-primary btn-lg">Crear nueva publicación</a>
            <?php endif; ?>
        </div>
    </section>
